...
//     const savedTasks = localStorage.getItem("tasks"); // чек наличие задач в локал сторедж
...
//   const updatedTasks = tasks.filter((task) => task.id !== id); // фильтр по совпадению с айди
//   saveTasksToLocalStorage(updatedTasks);
//   return updatedTasks;
// };
